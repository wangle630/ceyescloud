...
(function(d, f, b) {
    ...
    function c() {
        ...
        j = d('<div id="Validform_msg"><div class="Validform_title">' + e.tit + '</div><div class="Validform_info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body");
